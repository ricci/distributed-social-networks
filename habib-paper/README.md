...
`transform.py` is a simple script that transforms any of the datafiles into a 'worldwide' form (*not* what was done in the original paper) so that they can directly be consumed by `centralization-stats.py` in the parent directory
