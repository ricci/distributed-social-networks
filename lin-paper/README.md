...
The "common" file comes from the Alexa top 1M list; the "com" file comes from a random sampling of `.com` domain names, and the `gov` file comes from US government domains

The "common" file is currently the only one used in this project
